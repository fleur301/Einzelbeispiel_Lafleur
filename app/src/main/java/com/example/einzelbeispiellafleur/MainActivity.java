...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectToServer.setOnClickListener(
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        TCPConnectionAsClient tcpConnectionAsClient = new TCPConnectionAsClient();
                        new Thread(tcpConnectionAsClient).start();
                    }
                }
        );
        ...
        calculate.setOnClickListener(
                ...
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SortWithoutPrimes sortWithoutPrimes = new SortWithoutPrimes();
                        new Thread(sortWithoutPrimes).start();
                    }
                }
        );
    }
    ...
    class SortWithoutPrimes implements Runnable {
        @Override
        public void run() {
            Log.i("1", "OnClick");
    ...
    class TCPConnectionAsClient implements Runnable {
        @Override
        public void run() {
            EditText mat = findViewById(R.id.matrikelnummer);
            try {
